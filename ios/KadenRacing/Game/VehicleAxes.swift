...
enum VehicleAxes {
    ...
    /// Painted body AABB — skips wheels, glass, kits, plates, exhaust so bumper parts sit on the shell.
    static func paintedHull(in root: SCNNode) -> (min: SCNVector3, max: SCNVector3) {
        ...
        root.enumerateHierarchy { node, _ in
            ...
            if n.contains("wheel") || n.contains("tire") || n.contains("rubber")
                ...
                || n.contains("krcplate") || n.contains("krcsticker")
                || n.contains("krckidtoy") || n.contains("krcdriverhat")
                || n.contains("krcflame") {
                return
            }
